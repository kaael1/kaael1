...
## 🤖 AI Engineer | Expert in Intelligent Systems and Agent Architecture

Passionate developer focused on **Artificial Intelligence** and **Software Engineering**, specialized in building conversational agent systems, RAG (Retrieval-Augmented Generation) pipelines, and integrations with cutting-edge language models.
...
**Technologies**: TypeScript, Three.js, Web Audio API, Google Gemini, Web Components

**Highlights**:
- Real-time bidirectional audio streaming
- Procedural 3D visualizations reactive to audio
- Dynamic agent configuration system
- Custom shaders with bloom effects
...
**Technologies**: Next.js 16, FastAPI, Google ADK, Google Gemini, TypeScript, Python

**Highlights**:
- Structured data collection via natural conversation
- Real-time validation with intelligent inference
- Persistent state management with sessions
- Full-stack architecture with Docker support
...
**Technologies**: Next.js 16, Supabase (pgvector), OpenAI/Anthropic/Google, Confluence API, TypeScript

**Highlights**:
- Complete RAG with corporate documentation ingestion
- Multi-model support with automatic fallback
- Intelligent caching system for optimization
- Transaction analysis with risk detection and SLA monitoring
...
- 💼 [LinkedIn](https://www.linkedin.com/in/mikaelluca/)
- 🐙 [GitHub](https://github.com/kaael1)

---

## 💡 About Me

Developer focused on creating AI solutions that make a difference. Specialized in transforming cutting-edge technologies into practical and scalable applications, always prioritizing clean architecture, performance, and user experience.
